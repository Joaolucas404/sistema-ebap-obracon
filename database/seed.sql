...
values
  ('operador','Operador','Preenche RDO e solicita OS.',10),
  ('tecnico','Técnico','Executa OS diárias e registra execução.',20),
  ('cco','CCO','Valida RDO e OS geradas pela operação.',30),
...
values
  ...
  ('relatorio.read','RDO','relatorios','/relatorio','read'),
  ('relatorio.write','Criar RDO','relatorios','/relatorio','write'),
  ('cco_ro.read','Visualizar RDO no CCO','cco','/cco-relatorios-diarios','read'),
  ('cco_ro.validate','Validar RDO no CCO','cco','/cco-relatorios-diarios','approve'),
