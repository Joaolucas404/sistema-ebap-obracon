...
export default function OsDiariaDashboard({ dashboard }) {
  ...
  return (
    <section className="grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
      ...
      <KpiCard icon={CheckCircle2} label="Concluídas hoje" value={data.concluidasHoje || 0} helper="Finalizadas pelo técnico" tone="green" />
      <KpiCard icon={PlayCircle} label="Em execução" value={data.emExecucao || 0} helper="Atendimento aberto" tone="orange" />
