...
export const MENU_ITEMS = [
  ...
  { key: 'usuarios', group: 'Administrativo', label: 'Usuários', path: '/usuarios', icon: Users, description: 'Administração de acessos' },
  { key: 'modelosRelatorio', group: 'Administrativo', label: 'Modelos de Relatório', path: '/administrativo/modelos-relatorio', icon: FileCog, description: 'Padrões dos relatórios técnicos' },
