...
export const ROLE_PERMISSIONS = {
  ...
  supervisor: ['dashboard', 'agendaOperacional', 'notificacoes', 'comunicacao', 'localizacaoEbaps', 'ativos', 'os', 'supervisao', 'relatorio', 'ccoRelatoriosDiarios', 'manutencao', 'salaSituacaoEbaps', 'osDiaria', 'arquivoRelatorios', 'compras', 'orientacoes', 'usuarios', 'modelosRelatorio', 'perfil'],
  gerencia: [
    'dashboard',
    'agendaOperacional',
    'notificacoes',
  ...
  diretoria: ['*'],
  prefeitura: ['dashboard', 'notificacoes', 'comunicacao', 'os', 'localizacaoEbaps', 'ativos', 'relatorios', 'financeiroContrato', 'orientacoes', 'perfil'],
  fiscal_operacional: ['dashboard', 'os', 'perfil'],
  fiscal_gestor: ['dashboard', 'notificacoes', 'comunicacao', 'os', 'localizacaoEbaps', 'ativos', 'relatorios', 'financeiroContrato', 'orientacoes', 'perfil'],
...
export const START_ROUTE_BY_ROLE = {
  operador: '/relatorio',
  tecnico: '/os',
  cco: '/cco-relatorios-diarios',
  supervisor: '/agenda-operacional',
  gerencia: '/dashboard',
  diretoria: '/dashboard',
  prefeitura: '/dashboard',
  fiscal_operacional: '/dashboard',
  fiscal_gestor: '/dashboard',
  sst: '/dashboard',
